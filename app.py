...
# 處理訊息
def function(text):
    list=['路二四:基督受這些害，又進入祂的榮耀，豈不是應當的麼?','約七39:耶穌這話是指着信入祂的人將要受的那靈說的；那時還沒有那靈，因爲耶穌尚未得着榮耀。','徒一8:但聖靈降臨在你們身上，你們就必得着能力，並要在耶路撒冷、猶太全地、撒瑪利亞，直到地極，作我的見證人。','林前一9:神是信實的，你們乃是爲牠所召，進入祂兒子我們主耶穌基督的交通。']
    if text=='經節':
